...
exports.MsgExec = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.msgs.push(Sdk_MsgauthzAuthorization_InterfaceDecoder(reader));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromAmino(object) {
        return {
            grantee: object.grantee,
            msgs: Array.isArray(object?.msgs) ? object.msgs.map((e) => Sdk_MsgauthzAuthorization_FromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};

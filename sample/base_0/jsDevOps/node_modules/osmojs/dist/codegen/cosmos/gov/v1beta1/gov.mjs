...
export const DepositParams = {
    ...
    fromAmino(object) {
        return {
            ...
            minExpeditedDeposit: Array.isArray(object?.min_expedited_deposit) ? object.min_expedited_deposit.map((e) => Coin.fromAmino(e)) : [],
...
export const VotingParams = {
    ...
    fromAmino(object) {
        return {
            ...
            proposalVotingPeriods: Array.isArray(object?.proposal_voting_periods) ? object.proposal_voting_periods.map((e) => ProposalVotingPeriod.fromAmino(e)) : [],

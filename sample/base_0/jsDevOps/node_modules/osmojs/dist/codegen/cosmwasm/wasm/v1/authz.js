...
exports.ContractExecutionAuthorization = {
    ...
    fromAmino(object) {
        return {
            grants: Array.isArray(object?.grants) ? object.grants.map((e) => exports.ContractGrant.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};
...
exports.ContractGrant = {
    ...
    fromAmino(object) {
        return {
            ...
            limit: object?.limit ? (0, exports.Cosmwasm_wasmv1ContractAuthzLimitX_FromAmino)(object.limit) : undefined,
            filter: object?.filter ? (0, exports.Cosmwasm_wasmv1ContractAuthzFilterX_FromAmino)(object.filter) : undefined
        };
    },
    toAmino(message) {
        const obj = {};
...
exports.MaxFundsLimit = {
    ...
    fromAmino(object) {
        return {
            amounts: Array.isArray(object?.amounts) ? object.amounts.map((e) => coin_1.Coin.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};
...
exports.AcceptedMessagesFilter = {
    ...
    fromAmino(object) {
        return {
            messages: Array.isArray(object?.messages) ? object.messages.map((e) => e) : []
        };
    },
    toAmino(message) {
        const obj = {};
...
const Cosmwasm_wasmv1ContractAuthzLimitX_ToAmino = (content) => {
    switch (content.typeUrl) {
        case "/cosmwasm.wasm.v1.MaxCallsLimit":
            return {
                type: "wasm/MaxCallsLimit",
                value: exports.MaxCallsLimit.toAmino(exports.MaxCallsLimit.decode(content.value))
            };
        case "/cosmwasm.wasm.v1.MaxFundsLimit":
            return {
                type: "wasm/MaxFundsLimit",
                value: exports.MaxFundsLimit.toAmino(exports.MaxFundsLimit.decode(content.value))
            };
        case "/cosmwasm.wasm.v1.CombinedLimit":
            return {
                type: "wasm/CombinedLimit",
                value: exports.CombinedLimit.toAmino(exports.CombinedLimit.decode(content.value))
            };
        default:
...
const Cosmwasm_wasmv1ContractAuthzFilterX_ToAmino = (content) => {
    switch (content.typeUrl) {
        case "/cosmwasm.wasm.v1.AllowAllMessagesFilter":
            return {
                type: "wasm/AllowAllMessagesFilter",
                value: exports.AllowAllMessagesFilter.toAmino(exports.AllowAllMessagesFilter.decode(content.value))
            };
        case "/cosmwasm.wasm.v1.AcceptedMessageKeysFilter":
            return {
                type: "wasm/AcceptedMessageKeysFilter",
                value: exports.AcceptedMessageKeysFilter.toAmino(exports.AcceptedMessageKeysFilter.decode(content.value))
            };
        case "/cosmwasm.wasm.v1.AcceptedMessagesFilter":
            return {
                type: "wasm/AcceptedMessagesFilter",
                value: exports.AcceptedMessagesFilter.toAmino(exports.AcceptedMessagesFilter.decode(content.value))
            };
        default:
            return any_1.Any.toAmino(content);
    }

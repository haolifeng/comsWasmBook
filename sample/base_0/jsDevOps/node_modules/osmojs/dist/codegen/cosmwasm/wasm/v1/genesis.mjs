...
export const GenesisState = {
    ...
    fromAmino(object) {
        return {
            ...
            codes: Array.isArray(object?.codes) ? object.codes.map((e) => Code.fromAmino(e)) : [],
            contracts: Array.isArray(object?.contracts) ? object.contracts.map((e) => Contract.fromAmino(e)) : [],
            sequences: Array.isArray(object?.sequences) ? object.sequences.map((e) => Sequence.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};
...
export const Contract = {
    ...
    fromAmino(object) {
        return {
            ...
            contractState: Array.isArray(object?.contract_state) ? object.contract_state.map((e) => Model.fromAmino(e)) : [],
            contractCodeHistory: Array.isArray(object?.contract_code_history) ? object.contract_code_history.map((e) => ContractCodeHistoryEntry.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};

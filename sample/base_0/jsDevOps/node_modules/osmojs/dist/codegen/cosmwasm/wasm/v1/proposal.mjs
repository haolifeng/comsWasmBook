...
export const InstantiateContractProposal = {
    ...
    fromAmino(object) {
        return {
            ...
            funds: Array.isArray(object?.funds) ? object.funds.map((e) => Coin.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};
...
export const UpdateInstantiateConfigProposal = {
    ...
    fromAmino(object) {
        return {
            title: object.title,
            description: object.description,
            accessConfigUpdates: Array.isArray(object?.access_config_updates) ? object.access_config_updates.map((e) => AccessConfigUpdate.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};

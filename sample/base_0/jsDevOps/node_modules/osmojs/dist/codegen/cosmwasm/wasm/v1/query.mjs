...
export const QueryContractHistoryResponse = {
    ...
    fromAmino(object) {
        return {
            entries: Array.isArray(object?.entries) ? object.entries.map((e) => ContractCodeHistoryEntry.fromAmino(e)) : [],
...
export const QueryAllContractStateResponse = {
    ...
    fromAmino(object) {
        return {
            models: Array.isArray(object?.models) ? object.models.map((e) => Model.fromAmino(e)) : [],
            pagination: object?.pagination ? PageResponse.fromAmino(object.pagination) : undefined
        };
    },
    toAmino(message) {
...
export const QueryCodesResponse = {
    ...
    fromAmino(object) {
        return {
            codeInfos: Array.isArray(object?.code_infos) ? object.code_infos.map((e) => CodeInfoResponse.fromAmino(e)) : [],
            pagination: object?.pagination ? PageResponse.fromAmino(object.pagination) : undefined
        };
    },
    toAmino(message) {
...
export const QueryContractsByCreatorResponse = {
    ...
    fromAmino(object) {
        return {
            contractAddresses: Array.isArray(object?.contract_addresses) ? object.contract_addresses.map((e) => e) : [],
            pagination: object?.pagination ? PageResponse.fromAmino(object.pagination) : undefined
        };
    },
    toAmino(message) {

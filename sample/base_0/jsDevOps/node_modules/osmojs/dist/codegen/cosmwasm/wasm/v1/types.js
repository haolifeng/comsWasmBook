...
exports.Params = {
    ...
    fromAmino(object) {
        return {
            codeUploadAccess: object?.code_upload_access ? exports.AccessConfig.fromAmino(object.code_upload_access) : undefined,
...
exports.CodeInfo = {
    ...
    fromAmino(object) {
        return {
            ...
            instantiateConfig: object?.instantiate_config ? exports.AccessConfig.fromAmino(object.instantiate_config) : undefined
        };
    },
    toAmino(message) {
        const obj = {};
...
function createBaseContractInfo() {
    return {
        ...
        admin: "",
        label: "",
        created: exports.AbsoluteTxPosition.fromPartial({}),
        ibcPortId: "",
        extension: undefined
    };
}
exports.ContractInfo = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    message.extension = (0, exports.Cosmwasm_wasmv1ContractInfoExtension_InterfaceDecoder)(reader);
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromAmino(object) {
        return {
            ...
            admin: object.admin,
            label: object.label,
            created: object?.created ? exports.AbsoluteTxPosition.fromAmino(object.created) : undefined,
            ibcPortId: object.ibc_port_id,
            extension: object?.extension ? (0, exports.Cosmwasm_wasmv1ContractInfoExtension_FromAmino)(object.extension) : undefined
        };
    },
    toAmino(message) {
        const obj = {};
        ...
        obj.extension = message.extension ? (0, exports.Cosmwasm_wasmv1ContractInfoExtension_ToAmino)(message.extension) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
function createBaseContractCodeHistoryEntry() {
    return {
        operation: 0,
        codeId: BigInt(0),
        updated: exports.AbsoluteTxPosition.fromPartial({}),
        msg: new Uint8Array()
    };
}
exports.ContractCodeHistoryEntry = {
    ...
    fromAmino(object) {
        return {
            ...
            codeId: BigInt(object.code_id),
            updated: object?.updated ? exports.AbsoluteTxPosition.fromAmino(object.updated) : undefined,
...
exports.Cosmwasm_wasmv1ContractInfoExtension_InterfaceDecoder = Cosmwasm_wasmv1ContractInfoExtension_InterfaceDecoder;
const Cosmwasm_wasmv1ContractInfoExtension_FromAmino = (content) => {
    return any_1.Any.fromAmino(content);
};
exports.Cosmwasm_wasmv1ContractInfoExtension_FromAmino = Cosmwasm_wasmv1ContractInfoExtension_FromAmino;
const Cosmwasm_wasmv1ContractInfoExtension_ToAmino = (content) => {
    return any_1.Any.toAmino(content);
};
exports.Cosmwasm_wasmv1ContractInfoExtension_ToAmino = Cosmwasm_wasmv1ContractInfoExtension_ToAmino;

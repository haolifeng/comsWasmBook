...
export const QueryIncentivizedPacketsResponse = {
    ...
    fromAmino(object) {
        return {
            incentivizedPackets: Array.isArray(object?.incentivized_packets) ? object.incentivized_packets.map((e) => IdentifiedPacketFees.fromAmino(e)) : [],
...
export const QueryTotalRecvFeesResponse = {
    ...
    fromAmino(object) {
        return {
            recvFees: Array.isArray(object?.recv_fees) ? object.recv_fees.map((e) => Coin.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};
...
export const QueryTotalAckFeesResponse = {
    ...
    fromAmino(object) {
        return {
            ackFees: Array.isArray(object?.ack_fees) ? object.ack_fees.map((e) => Coin.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};
...
export const QueryTotalTimeoutFeesResponse = {
    ...
    fromAmino(object) {
        return {
            timeoutFees: Array.isArray(object?.timeout_fees) ? object.timeout_fees.map((e) => Coin.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};
...
export const QueryFeeEnabledChannelsResponse = {
    ...
    fromAmino(object) {
        return {
            feeEnabledChannels: Array.isArray(object?.fee_enabled_channels) ? object.fee_enabled_channels.map((e) => FeeEnabledChannel.fromAmino(e)) : [],
            pagination: object?.pagination ? PageResponse.fromAmino(object.pagination) : undefined
        };
    },
    toAmino(message) {

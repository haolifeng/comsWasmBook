...
export const ControllerGenesisState = {
    ...
    fromAmino(object) {
        return {
            activeChannels: Array.isArray(object?.active_channels) ? object.active_channels.map((e) => ActiveChannel.fromAmino(e)) : [],
            interchainAccounts: Array.isArray(object?.interchain_accounts) ? object.interchain_accounts.map((e) => RegisteredInterchainAccount.fromAmino(e)) : [],

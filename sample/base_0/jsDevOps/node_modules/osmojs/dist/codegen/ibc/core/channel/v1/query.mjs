...
export const QueryPacketAcknowledgementsRequest = {
    ...
    fromAmino(object) {
        return {
            ...
            channelId: object.channel_id,
            pagination: object?.pagination ? PageRequest.fromAmino(object.pagination) : undefined,
            packetCommitmentSequences: Array.isArray(object?.packet_commitment_sequences) ? object.packet_commitment_sequences.map((e) => BigInt(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};
...
export const QueryUnreceivedAcksRequest = {
    ...
    fromAmino(object) {
        return {
            portId: object.port_id,
            channelId: object.channel_id,
            packetAckSequences: Array.isArray(object?.packet_ack_sequences) ? object.packet_ack_sequences.map((e) => BigInt(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};

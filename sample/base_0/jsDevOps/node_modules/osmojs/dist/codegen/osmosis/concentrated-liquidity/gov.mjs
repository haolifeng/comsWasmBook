...
export const CreateConcentratedLiquidityPoolsProposal = {
    ...
    fromAmino(object) {
        return {
            ...
            poolRecords: Array.isArray(object?.pool_records) ? object.pool_records.map((e) => PoolRecord.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};
...
export const TickSpacingDecreaseProposal = {
    ...
    fromAmino(object) {
        return {
            title: object.title,
            description: object.description,
            poolIdToTickSpacingRecords: Array.isArray(object?.pool_id_to_tick_spacing_records) ? object.pool_id_to_tick_spacing_records.map((e) => PoolIdToTickSpacingRecord.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};

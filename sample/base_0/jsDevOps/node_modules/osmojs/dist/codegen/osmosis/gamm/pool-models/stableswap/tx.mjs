...
export const MsgCreateStableswapPool = {
    ...
    fromAmino(object) {
        return {
            ...
            initialPoolLiquidity: Array.isArray(object?.initial_pool_liquidity) ? object.initial_pool_liquidity.map((e) => Coin.fromAmino(e)) : [],
            scalingFactors: Array.isArray(object?.scaling_factors) ? object.scaling_factors.map((e) => BigInt(e)) : [],

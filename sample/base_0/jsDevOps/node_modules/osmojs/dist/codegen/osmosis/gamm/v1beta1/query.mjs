...
export const QueryCalcJoinPoolSharesRequest = {
    ...
    fromAmino(object) {
        return {
            poolId: BigInt(object.pool_id),
            tokensIn: Array.isArray(object?.tokens_in) ? object.tokens_in.map((e) => Coin.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};
...
export const QueryCalcJoinPoolSharesResponse = {
    ...
    fromAmino(object) {
        return {
            ...
            tokensOut: Array.isArray(object?.tokens_out) ? object.tokens_out.map((e) => Coin.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};

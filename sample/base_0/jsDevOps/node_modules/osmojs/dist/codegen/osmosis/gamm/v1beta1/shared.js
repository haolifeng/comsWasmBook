...
exports.MigrationRecords = {
    ...
    fromAmino(object) {
        return {
            balancerToConcentratedPoolLinks: Array.isArray(object?.balancer_to_concentrated_pool_links) ? object.balancer_to_concentrated_pool_links.map((e) => exports.BalancerToConcentratedPoolLink.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};

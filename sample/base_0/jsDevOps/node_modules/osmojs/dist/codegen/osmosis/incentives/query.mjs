...
export const UpcomingGaugesPerDenomResponse = {
    ...
    fromAmino(object) {
        return {
            upcomingGauges: Array.isArray(object?.upcoming_gauges) ? object.upcoming_gauges.map((e) => Gauge.fromAmino(e)) : [],
            pagination: object?.pagination ? PageResponse.fromAmino(object.pagination) : undefined
        };
    },
    toAmino(message) {
...
export const RewardsEstRequest = {
    ...
    fromAmino(object) {
        return {
            owner: object.owner,
            lockIds: Array.isArray(object?.lock_ids) ? object.lock_ids.map((e) => BigInt(e)) : [],

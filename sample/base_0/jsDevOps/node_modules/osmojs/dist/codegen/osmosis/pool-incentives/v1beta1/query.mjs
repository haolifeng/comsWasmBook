...
export const QueryGaugeIdsResponse = {
    ...
    fromAmino(object) {
        return {
            gaugeIdsWithDuration: Array.isArray(object?.gauge_ids_with_duration) ? object.gauge_ids_with_duration.map((e) => QueryGaugeIdsResponse_GaugeIdWithDuration.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};
...
export const QueryIncentivizedPoolsResponse = {
    ...
    fromAmino(object) {
        return {
            incentivizedPools: Array.isArray(object?.incentivized_pools) ? object.incentivized_pools.map((e) => IncentivizedPool.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};

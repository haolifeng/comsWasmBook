...
export const GenesisState = {
    ...
    fromAmino(object) {
        return {
            ...
            tokenPairArbRoutes: Array.isArray(object?.token_pair_arb_routes) ? object.token_pair_arb_routes.map((e) => TokenPairArbRoutes.fromAmino(e)) : [],
            ...
            developerFees: Array.isArray(object?.developer_fees) ? object.developer_fees.map((e) => Coin.fromAmino(e)) : [],

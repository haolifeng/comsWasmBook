...
const createRPCMsgClient = async ({ rpc }) => ({
    ...
    osmosis: {
        concentratedliquidity: {
            poolmodel: {
                concentrated: {
                    v1beta1: new (await Promise.resolve().then(() => __importStar(require("./concentrated-liquidity/pool-model/concentrated/tx.rpc.msg")))).MsgClientImpl(rpc)
                }
            },
            v1beta1: new (await Promise.resolve().then(() => __importStar(require("./concentrated-liquidity/tx.rpc.msg")))).MsgClientImpl(rpc)
        },
        gamm: {
            poolmodels: {
                balancer: {
